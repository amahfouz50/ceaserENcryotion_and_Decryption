...
public class Main extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel13.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/title.png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
         if (jTextField1.getText().isEmpty()){
            ...
            try {
            jTextField3.setText(new Ceazer().encrypt(jTextField1.getText(), Integer.parseInt(jTextField2.getText())));
            }catch(Exception e){
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
         if (jTextField15.getText().isEmpty()){
            JOptionPane.showMessageDialog(null, "No cipher Text Found  !");
                   ...
                   try {
        jTextField13.setText(new Ceazer().decrypt(jTextField15.getText(), Integer.parseInt(jTextField14.getText())));
